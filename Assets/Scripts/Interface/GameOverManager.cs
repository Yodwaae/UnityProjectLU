...
public class GameOverManager : MonoBehaviour
{
    ...
    public void onPlayerDeath()
    {
        ...
        //le son n'a donc pas le temps de se jouer si on met le landcement du son dans le script Health
        audioSource.PlayOneShot(death);
        scoreKillAllies.text = "Score allie : " + PlayerPrefs.GetInt("countScoreAlly").ToString(); //récupère le score du nombre d'alliés tués (voir Interface.cs)
        scoreKillEnemies.text = "Score ennemis : " + PlayerPrefs.GetInt("countScoreEnemy").ToString(); //récupère le score du nombre d'ennemis tués (voir Interface.cs)
    ...
    public void MainMenuButton()
    {
        ...
        audioButton.Play(); //joue le son d'interrupteur de lampe
    }
